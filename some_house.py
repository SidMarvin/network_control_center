"""
Нужно добавить в соответствующую таблицу столбец с выбором серверной. А в гуйце создать пункт с выпадающим списком, который будет относить данный многоквартирный дом к той или иной серверной. Так будет проще сортировать их в будущем
"""
